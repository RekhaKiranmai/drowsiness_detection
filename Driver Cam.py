...
root.title('Detect Drowsiness')
frame.config(background='white')
label = Label(frame, text="Detect Drowsiness",bg='white',font=('Times 35 bold'))
label.pack(side=TOP)
...
but1=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=blink,text='Detect Eye Blink',font=('helvetica 15 bold'))
but1.place(x=100,y=300)

but2=Button(frame,padx=5,pady=5,width=5,bg='white',fg='black',relief=GROOVE,text='EXIT',command=exitt,font=('helvetica 15 bold'))
but2.place(x=300,y=478)
